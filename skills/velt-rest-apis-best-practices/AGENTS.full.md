...
2. [REST API Endpoints](#2-rest-api-endpoints) — **HIGH**
   ...
   - 2.3 [Document, Organization, and Folder Management via REST API](#23-document-organization-and-folder-management-via-rest-api)
   - 2.4 [Notification Management via REST API](#24-notification-management-via-rest-api)
   - 2.5 [User Management via REST API](#25-user-management-via-rest-api)
...
### 2.3 Document, Organization, and Folder Management via REST API
...
### 2.4 Notification Management via REST API
...
### 2.5 User Management via REST API
