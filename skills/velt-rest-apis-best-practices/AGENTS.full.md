...
2. [REST API Endpoints](#2-rest-api-endpoints) — **HIGH**
   ...
   - 2.2 [Approval Engine REST API — Definitions, Executions, and Steps](#22-approval-engine-rest-api-definitions-executions-and-steps)
...
### 2.2 Approval Engine REST API — Definitions, Executions, and Steps

**Impact: HIGH (Incorrect auth, missing idempotency keys, or wrong node/group shape causes silent duplicate executions or permanently stuck workflows)**
